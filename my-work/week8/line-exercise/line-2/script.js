...
function americaData(){
  let data = incomingData[2];
  drawLine();
}
document.getElementById("buttonChina").addEventListener("click", chinaData);
document.getElementById("buttonAmerica").addEventListener("click", americaData);
